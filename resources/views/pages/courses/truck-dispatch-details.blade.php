...
@section('title', 'Truck Dispatch Details')
@section('content')
                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            <nav class="breadcrumb">
                                ...
                                <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                <span property="itemListElement" typeof="ListItem">Truck Dispatch</span>
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        <div class="courses__details-thumb">
                            <img src="assets/img/courses/truck-dispatch-course.png" alt="img">
                        </div>
                        <div class="courses__details-content">
                            ...
                            {{-- <div class="courses__details-meta">
                                <ul class="list-wrap">
                                    <li class="author-two">
                                        <img src="assets/img/courses/course_author001.html" alt="img">
                                        By
                                    ...
                                    <div class="courses__overview-wrap">
                                        ...
                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                ...
                                                <p class="content">Load Booking & Negotiation</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Route Planning & Tracking</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Broker Communication</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Documentation & Software Use</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Real Time Dispatch Handling</p>
                                            </li>
                                        </ul>
                                ...
                                <div class="tab-pane fade" id="reviews-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__rating-wrap">
                                        ...
                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Truck Dispatcher</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Freight Dispatcher</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Logistics Coordinator</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Load Planner</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Fleet Coordinator</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Freight Broker Assistant</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Remote Dispatcher (USA/Canada)</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
