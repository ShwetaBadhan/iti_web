...
@section('title', 'Electrician Details')
@section('content')
                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                <span property="itemListElement" typeof="ListItem">Electrician</span>
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        <div class="courses__details-thumb">
                            <img src="assets/img/courses/electnician-details.png" alt="img">
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__overview-wrap">
                                        ...
                                        <p align="justify">After completing the course, students can work with electrical contractors, construction companies, industries, maintenance departments, or start their own electrical service business.</p>

                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">House & Commercial Wiring</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Electrical Installation & Maintenance</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Motor Wiring & Control Panels</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Electrical Safety & Testing</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Fault Finding & Troubleshooting</p>
                                            </li>
                                ...
                                <div class="tab-pane fade" id="curriculum-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__curriculum-wrap">
                                        <h3 class="title">Build a Career in the Electrical Industry</h3>
                                        <p align="justify">Electricians are highly skilled professionals responsible for installing, maintaining, and repairing electrical systems in residential, commercial, and industrial buildings. With rapid infrastructure development and increasing demand for electrical services, skilled electricians enjoy excellent career opportunities in India and abroad.
                                        </p>
                                        <p align="justify">At Dr. B. R. Ambedkar ITI, Jalandhar, we offer a Practical Electrician Training Program that combines classroom learning with hands-on practical sessions. Students gain real-world experience in electrical wiring, installation, maintenance, safety practices, and troubleshooting, preparing them for successful careers in the electrical industry.</p>
                                        ...
                                        <p align="justify">Upon successful completion of the course, students receive a
                                            <strong>Government Approved Certificate</strong> from <strong>Dr. B. R. Ambedkar
                                                ITI, Jalandhar</strong>, enhancing their credibility and employment opportunities.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="reviews-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__rating-wrap">
                                        ...
                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Electrician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Electrical Technician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Maintenance Electrician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Industrial Electrician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Control Panel Technician</p>

                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Electrical Supervisor</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Solar Installation Technician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Self-Employed Electrician</p>
                                            </li>
