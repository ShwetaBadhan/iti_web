...
@section('title', 'Plumbing Details')
@section('content')
                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                <span property="itemListElement" typeof="ListItem">Plumbing</span>
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        <div class="courses__details-thumb">
                            <img src="assets/img/courses/plumbing-details.png" alt="img">
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__overview-wrap">
                                        ...
                                        <p align="justify">After completing the course, students will have the practical
                                            skills required to work with construction companies, maintenance firms, plumbing
                                            contractors, government projects, or start their own plumbing business.</p>

                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Water Supply System Installation</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Pipe Fitting & Jointing Techniques</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Sanitary Ware Installation</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Leak Detection & Plumbing Repairs</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Plumbing Tools, Safety & Maintenance</p>
                                            </li>
                                ...
                                <div class="tab-pane fade" id="curriculum-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__curriculum-wrap">
                                        <h3 class="title">Build a Career in the Plumbing Industry</h3>
                                        <p align="justify">Plumbing is one of the most essential and in-demand skilled
                                            trades across residential, commercial, and industrial sectors. A Professional
                                            Plumber is responsible for installing, repairing, and maintaining water supply
                                            systems, drainage systems, sanitary fittings, and pipelines while ensuring
                                            safety and efficiency.
                                        </p>
                                        <p align="justify">At Dr. B. R. Ambedkar ITI, Jalandhar, we offer a Practical
                                            Plumbing Training Program designed to equip students with industry-relevant
                                            knowledge and hands-on experience. The course focuses on pipe installation,
                                            plumbing tools, sanitary fittings, leak detection, water supply systems,
                                            drainage systems, and real-world practical training to prepare students for
                                            employment in India and abroad.</p>
                                ...
                                <div class="tab-pane fade" id="reviews-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__rating-wrap">
                                        ...
                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Professional Plumber</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Pipe Fitter</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Plumbing Technician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Maintenance Technician</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Sanitary Installation Technician</p>

                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Construction Site Plumber</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Self-Employed Plumbing Contractor</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Overseas Plumbing Professional</p>
                                            </li>
