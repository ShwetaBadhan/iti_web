    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div class="">
            <h1 class="fw-semibold mb-4 h6 text-primary-light">
                {{ $message ? 'Edit Director Message' : 'Add Director Message' }}
            </h1>
            <div class="">
                <a href="{{ route('dashboard') }}" class="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
                <span class="text-secondary-light">/ Director Message</span>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
    ...
    <div class="mt-24">
        <div class="card h-100">
            <div class="card-body">
                ...
                <form action="{{ route('director-message.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="designation" class="form-control" 
                                           ...
                                           placeholder="e.g. Director, Board of Directors">
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-semibold">Message <span class="text-danger">*</span></label>
                                    <textarea name="message" class="form-control" rows="8" 
                                              placeholder="Write the Director's message here..." required>{{ old('message', $message->message ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
