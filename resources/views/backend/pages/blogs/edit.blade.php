                        ...
                        <div class="col-lg-8">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="title" id="blogTitle" class="form-control" value="{{ old('title', $blog->title) }}" required oninput="generateSlug(this.value)">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">URL Slug <small class="text-muted">(Auto)</small></label>
                                    <input type="text" id="slugPreview" class="form-control bg-light" value="{{ $blog->slug }}" readonly>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="category" class="form-control" value="{{ old('category', $blog->category) }}" placeholder="e.g., Technology, News">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="tags" class="form-control" value="{{ old('tags', $blog->tags) }}" placeholder="e.g., truck, dispatch, logistics (comma separated)">
                                </div>
                            </div>
                        </div>
                    </div>
